    ...
    (b = (function () {
        function c(c, d) {
            ...
            (e.defaults = {
                ...
                arrows: !0,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" class="slick-prev"  tabindex="0" role="button"> <svg width="12" height="19" viewBox="0 0 129 200" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M100.412 0L0.708984 99.702L100.412 199.404L128.695 171.119L57.277 99.702L128.695 28.285L100.412 0Z" fill="black"/> </svg> </button>',
                nextArrow: '<button type="button" data-role="none" class="slick-next"  tabindex="0" role="button"> <svg width="12" height="19" viewBox="0 0 160 256" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M31.093 0L0.906982 30.187L98.72 128L0.906982 225.813L31.093 256L159.093 128L31.093 0Z" fill="black"/> </svg> </button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
